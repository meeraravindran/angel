  ...
  return (
    <div className="post-jobs">
      <div className="pj-img-div">
        <img className="pj-img" src={LocationImg} />
      </div>
      <div className="pj-heading">
        <h1>
          100,000<span style={{ fontSize: "50px" }}>+</span>
        </h1>
        <p>
          of the world's top startups, from seed to post-IPO, build teams on
          AngelList.
        </p>
      </div>
      <div className="pj-content">
        <div className="pj-desc">
          <p className="pj-desc-p">
            Post jobs, find candidates, and manage your talent pipeline with
            AngelList's complete hiring toolkit.
          </p>
          <TwoColumns
